...
import { DollarSign, Edit3, FileText, Loader2, Plus, Package, Tag, Calendar } from 'lucide-react';
import { useProductsStore } from '@/store/useProductsStore';
import DatePicker from 'react-datepicker';
import 'react-datepicker/dist/react-datepicker.css';
import dayjs from 'dayjs';

const addProductByDate = () => {
  ...
  const { isLoading, addProductByDate } = useProductsStore();
  ...
  const handleSubmit = (e) => {
    ...
    addProductByDate(formattedDate, formattedProduct);
          ...
          <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            >
              ...
              <p className="text-emerald-100 mt-2 text-sm md:text-base">
                Ku dar alaabta laga soo daayay taariikh ahaan
              </p>
            </motion.div>
                ...
                >
                  ...
                  <div className="relative">
                    <DatePicker
                      ...
                      maxDate={new Date()}
                      placeholderText="Dooro taariikhda"
                  ...
                  >
                    {isLoading ? (
                      ...
                      <>
                        ...
                        <span className="font-semibold">KU DAR TARIIKHDA</span>
                      </>
                    )}
                  </button>
                </motion.div>
...
export default addProductByDate;